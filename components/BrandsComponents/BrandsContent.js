...
export default function BrandsContent() {
  return (
    <div className="flex min-h-screen flex-col bg-peach font-serif">
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-1 flex-col px-5 pt-6 pb-16 md:px-8 md:pt-8 md:pb-20 lg:px-10 lg:pb-24">
        <nav
          aria-label="Breadcrumb"
          className="mb-8 text-[13px] text-navy/60 md:mb-10 md:text-[14px]"
        >
          <Link href="/" className="transition-colors hover:text-navy">
            Home
          </Link>
          <span>/</span>
          <span className="text-navy">Our Brands</span>
        </nav>
